...
const Addsanpham = () => {
    ...
    //         const CLOUD_NAME = "dwgf63hoq";
    //         const PRESET_NAME = "dinhtai"
    //         const FOLDER_NAME = "ass2";
    //         const urls = [];
    //         const api = `https://api.cloudinary.com/v1_1/demo/image/upload`
    //         const formData = new FormData();
    //         formData.append("upload_presets", PRESET_NAME);
        ...
        <form action="" className="flex gap-[40px]" >
            <div className=" w-[300px] h-[300px] border rounded-md border-red-500 ml-[50px] mt-[15px] border-gray-400">
                <div className="btn_img h-[220px] relative">
                    ...
                    {/* <input {...register("image")} className="img_hidden absolute w-[98%] h-[220px] top-[0px] left-[3px]" type="file" /> */}
                </div>
            </div>
